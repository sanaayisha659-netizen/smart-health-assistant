SYMPTOMS = {
    "fever": "Possible infection, viral fever, or inflammation",
    "chills": "Fever or infection",
    "night sweats": "Infection or hormonal changes",

    "cough": "Cold, allergy, or respiratory infection",
    "dry cough": "Allergy, viral infection, or irritation",
    "shortness of breath": "Asthma, anxiety, or lung-related issue (see doctor)",
    "sore throat": "Throat infection or cold",
    "runny nose": "Cold or allergy",
    "nasal congestion": "Sinus or allergy",

    "headache": "Stress, dehydration, migraine, or lack of sleep",
    "dizziness": "Low BP, dehydration, or anemia",
    "confusion": "Low sugar, infection, or neurological issue (urgent)",

    "stomach pain": "Indigestion, gas, or infection",
    "nausea": "Food poisoning, acidity, or pregnancy",
    "vomiting": "Food infection or stomach upset",
    "diarrhea": "Food infection or dehydration",
    "constipation": "Low fiber intake or dehydration",
    "acid reflux": "Gastric problem or spicy food",

    "chest pain": "Gas, muscle strain, or heart-related issue (see doctor)",
    "palpitations": "Anxiety, caffeine, or heart rhythm issue",
    "high blood pressure": "Stress, obesity, or lifestyle-related issue",

    "back pain": "Muscle strain or poor posture",
    "joint pain": "Arthritis, injury, or inflammation",
    "muscle pain": "Overuse or vitamin deficiency",

    "fatigue": "Poor sleep, stress, anemia, or infection",
    "weakness": "Low energy, anemia, or dehydration",
    "weight loss": "Diet change, stress, or metabolic issue",
    "weight gain": "Hormonal changes or lifestyle factors",

    "itching": "Allergy or skin irritation",
    "rash": "Allergy or skin infection",
    "dry skin": "Dehydration or weather change",

    "burning urination": "Urinary tract infection (UTI)",
    "frequent urination": "Diabetes or UTI",
    "dark urine": "Dehydration or liver-related issue",

    "anxiety": "Stress or emotional overload",
    "stress": "Work, study, or lifestyle pressure",
    "low mood": "Stress or emotional fatigue"
}
MEDICINES = {
    ...
    "diazepam": "Used for anxiety and muscle relaxatio
